...
class PartidoAdmin(admin.ModelAdmin):
    ...
    def acciones(self, obj):
        ...
        if not obj.terminado and obj.equipo_local and obj.equipo_visitante:
            ...
            return format_html(
                '<a class="button" href="{}" style="background: #4CAF50; color: white; padding: 5px 10px; border-radius: 4px; text-decoration: none;">🏆 Marcar Ganador</a>',
                url
            )
        return '-'
...
class TorneoAdminSimple(admin.ModelAdmin):
    ...
    def boton_preparar(self, obj):
        ...
        return format_html(
            '<a class="button" href="{}" style="background: #4CAF50; color: white; padding: 8px 15px; border-radius: 4px; text-decoration: none; font-weight: bold;">🎯 PREPARAR TORNEO</a>',
            url
        )
