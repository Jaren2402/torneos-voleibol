"""
Django settings for voley_app project.
...
SECRET_KEY = 'django-insecure-w4qc8$87j8cr9!(0pn)qquyg(#yeik6i6e43ue73+^=*1^vo_6'
...
WSGI_APPLICATION = 'voley_app.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_ROOT = '/home/VoleibolApp/staticfiles'
